      ...
      <div className="space-y-10 text-[#374151] leading-relaxed">
        ...
        <section>
          ...
          <ul className="list-disc space-y-2 pl-6">
            ...
            <li>Subscriptions are billed in advance via Stripe on the monthly or annual billing interval selected at checkout. Your subscription renews automatically at the end of each billing period.</li>
