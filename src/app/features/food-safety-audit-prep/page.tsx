  ...
  return (
    <FeatureTemplate
      ...
      outcomes={[
        ...
        "Create a stronger handoff into specialist review where needed.",
      ]}
      sections={[
        {
        ...
        },
        {
          ...
          body:
            "Where the work has real compliance risk, PinkPepper's positioning is not 'publish AI output and hope'. It is 'draft faster, review better, export cleanly, and escalate to specialist review when necessary.'",
        },
      ]}
      relatedLinks={[
        {
        ...
        },
        {
          href: "/pricing",
          label: "Pricing",
          description: "Review the plans that cover exports, audit workflows, and specialist review credits.",
        },
      ]}
    />
  );
