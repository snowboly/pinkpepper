    ...
    <main className="relative overflow-hidden py-16 md:py-24">
      ...
      <div className="pp-container">
        <div className="mx-auto max-w-md rounded-[2rem] border border-[#E8DADA] bg-white p-7 shadow-xl md:p-8">
          ...
          <h1 className="mt-4 text-3xl font-black tracking-tight text-[#2B2B2B]">Reset Password</h1>
          <p className="mt-2 text-sm text-[#6B6B6B]">Enter your account email to receive a reset link.</p>
