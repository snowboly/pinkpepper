...
describe("TIER_CAPABILITIES – plus tier", () => {
  ...
  it("dailyDocumentGenerations is 3", () => expect(plus.dailyDocumentGenerations).toBe(3));
...
describe("TIER_CAPABILITIES – pro tier", () => {
  ...
  it("reviewTurnaround is 3-5 working days", () => expect(pro.reviewTurnaround).toMatch(/^3.5 working days$/));
