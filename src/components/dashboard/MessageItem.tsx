    ...
    <div className="group py-5">
      <div className="mx-auto max-w-5xl px-4 md:px-6">
        ...
        <div className="pl-9">
          ...
          {message.userDocumentNames && message.userDocumentNames.length > 0 && (
            <div className="mt-3 flex flex-wrap gap-1.5">
              {message.userDocumentNames.map((name) => (
                <span
                  key={name}
                  className="inline-flex items-center gap-1 rounded-full border border-[#E2E8F0] bg-[#F8FAFC] px-2.5 py-0.5 text-xs text-[#475569]"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3 flex-shrink-0 text-[#94A3B8]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                  </svg>
                  {name}
                </span>
