    ...
    <div>
      ...
      <div className="mx-auto grid max-w-5xl items-stretch gap-6 lg:grid-cols-3">
        <div className="flex h-full flex-col rounded-3xl border border-[#E2E8F0] bg-[#FCFDFE] p-8">
          ...
          <p className="mt-4 min-h-[4.5rem] text-sm leading-relaxed text-[#64748B]">For trying AI food safety assistant features on everyday food safety questions before upgrading.</p>
          ...
          <PlanList items={["Chat on web and mobile", "Create HACCP, SOP, and allergen drafts", "Analyze text and images", "Access curated food safety guidance", "Basic usage limits"]} muted />
