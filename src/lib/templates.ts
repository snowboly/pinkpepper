...
export const TEMPLATES: TemplateEntry[] = [
  ...
  // Monitoring
  { slug: "chill-chain-poster",                   title: "Chill chain checklist poster",           category: "Monitoring",   fileType: "png" },
  ...
  { slug: "handwashing-poster",                   title: "Handwashing checklist poster",           category: "Training",     fileType: "png" },
...
export function getGroupedTemplates(): TemplateGroup[] {
  const fileTypeRank = (template: TemplateEntry) => (template.fileType === "png" ? 1 : 0);
  ...
  const sorted = [...TEMPLATES].sort((a, b) => {
    ...
    const fileTypeCompare = fileTypeRank(a) - fileTypeRank(b);
    if (fileTypeCompare !== 0) {
      return fileTypeCompare;
    }
