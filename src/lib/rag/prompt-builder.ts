...
2. Cite sources precisely using the exact format [Source: document name, Article/Section X] every time you reference a regulation, standard, or guidance document — whether quoting, paraphrasing, or summarising. Do NOT mention a regulation or guidance in prose without tagging it. Do NOT invent document names, publication dates, or section numbers. Only cite documents that appear in the CONTEXT DOCUMENTS section below; if a document is not in context, reference it generically (e.g. "Regulation (EC) No 852/2004") without a [Source: ] tag and without fabricating a section number.
