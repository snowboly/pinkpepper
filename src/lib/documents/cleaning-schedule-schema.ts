...
// Fixed columns: Item | Method | Chemical | Dilution | Contact Time | Frequency | Responsible | Verification
...
// Fixed columns: Item | Method | Chemical | Dilution | Contact Time | Responsible | Verification
...
// Fixed columns: Item | Method | Chemical | Responsible | Verification
...
// Fixed columns: Chemical Name | Product | Dilution | Contact Time | Active Ingredient | COSHH Sheet Location
...
// Fixed columns: Surface Category | Pass | Borderline | Fail
...
// ── Default table data from template ──────────────────────────────────────────
...
export const DEFAULT_DAILY_TASKS: DailyCleaningRow[] = [
  ...
  { item: "Knives and utensils", method: "M3", chemical: "Dishwasher", dilution: "—", contactTime: "60°C wash", frequency: "After each use", responsible: "Food handlers", verification: "Visual" },
